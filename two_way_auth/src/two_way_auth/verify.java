...
public class verify extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(otp, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                ...
                if(otp.getText().equals("")){
                  ...
                  try{
                        username=Main.to;
                        rs=stmt.executeQuery("select AES_DECRYPT(otp,keyy) from userr where email='"+username+"'");
                        while(rs.next())
                        {
                            password=rs.getString(1);
                        }
                        if(this.otp.getText().equals(password)){
                            jLabel2.setText("VALID OTP");
                            stmt.executeUpdate("delete from userr where email='"+username+"'");
                        }
                        else{
                            jLabel2.setText("INVALID OTP");
                        }
